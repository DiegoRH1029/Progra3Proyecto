...
public class PanelGastos extends JPanel {
	...
	public PanelGastos() {
        ...
        setBorder(new EmptyBorder(30, 50, 30, 50)); // Margen exterior
        ...
        // CONTENEDOR CENTRAL (Usa GridBagLayout para centrar la tarjeta y que no se estire)
        JPanel panelContenedorForm = new JPanel(new GridBagLayout());
        panelContenedorForm.setBackground(new Color(30, 30, 30));
        
        // TARJETA DEL FORMULARIO (Diseño oscuro elegante)
        JPanel panelFormulario = new JPanel(new GridBagLayout());
        panelFormulario.setBackground(new Color(45, 45, 45));
        panelFormulario.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(new Color(211, 47, 47), 2), // Borde rojo tenue
            new EmptyBorder(40, 50, 40, 50) // Espaciado interno de la tarjeta
        ));

        GridBagConstraints gbc = new GridBagConstraints();
        gbc.fill = GridBagConstraints.HORIZONTAL;
        gbc.insets = new Insets(15, 10, 15, 10); // Espacio entre filas
        ...
        // Animación del botón (Hover)
        btnGuardarGasto.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent evt) {
                btnGuardarGasto.setBackground(new Color(255, 193, 7));
                btnGuardarGasto.setForeground(Color.BLACK);
            }
            public void mouseExited(MouseEvent evt) {
                btnGuardarGasto.setBackground(new Color(211, 47, 47));
                btnGuardarGasto.setForeground(Color.WHITE);
            }
        });
        ...
        gbc.insets = new Insets(30, 0, 0, 0); // Más espacio arriba del botón
